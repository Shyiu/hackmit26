  ...
  return (
    <div className="flex min-h-dvh flex-col items-center px-5 pt-[max(2rem,env(safe-area-inset-top))] pb-[max(2rem,env(safe-area-inset-bottom))] sm:justify-center">
      <div className="flex w-full max-w-sm flex-col gap-7">
        <Link href="/" aria-label="Memoir home" className="self-start text-base">
          <Wordmark />
        </Link>
        <div>
        ...
        <div className="rounded-3xl bg-card p-5 shadow-[0_4px_20px_-8px_rgb(20_45_120/0.18)] ring-1 ring-foreground/5">
          {children}
        </div>
