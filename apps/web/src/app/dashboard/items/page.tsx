            ...
            return (
              <li key={item._id.toHexString()}>
                <Link
                  ...
                  className="group flex h-full flex-col gap-3 rounded-3xl bg-card p-4 shadow-[0_4px_20px_-8px_rgb(60_30_20/0.15)] ring-1 ring-foreground/5 transition-colors hover:bg-muted/50 focus-visible:ring-3 focus-visible:ring-ring/50 focus-visible:outline-none"
                >
