...
The Next.js 16 app: the `/wear` chest page, the flat `/sim` fallback, the caregiver dashboard, and the API. The root PLAN.md is the spec; this file only says where things are.
...
- `src/app/api/*/route.ts`: one file per resource, matching the PLAN.md "API sketch".
