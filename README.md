...
| `GET, POST /api/auth/caregiver-link` | The wearer's own side of `/wearer-connect`: whether a caregiver has joined them yet, and a fresh code when the last one expired |
